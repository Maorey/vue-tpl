/**
 * A basic Nightwatch custom command which demonstrates usage of
 *  ES6 async/await instead of using callbacks.
...
module.exports = {
  command: async function() {
    ...
    // .init() simply calls .url() command with the
    //   value of the "launch_url" setting
    this.init()
