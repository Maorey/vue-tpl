/**
 * A very basic Nightwatch custom command.
 *  The command name is the filename and the
...
exports.command = function(data) {
  ...
  this.execute(
    ...
    // The arguments for the function to be sent to
    //  the browser are specified in this array
    [data],

    function(result) {
      // The "result" object contains the result from
      //  the what we have sent back from the browser window
      console.info('custom execute result:', result.value)
    }
  )
